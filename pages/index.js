...
const HowToUse = () => {
  return (
    <Card style={{ padding: 20, boxShadow: "none" }}>
      <Typography style={{ fontWeight: 600, fontSize: 24, marginBottom: 24 }}>
        How To use:
      </Typography>
      <p style={{ fontSize: 16, marginBottom: 24 }}>
        Follow these steps to setup free shipping with a minimum order value for
        your Shopify store:
      </p>
      <ol style={{ fontSize: 16, marginLeft: -20 }}>
        ...
        <li>
          Enter a minimum order price (same as the goal in the Free Shipping Bar
          app)
        </li>
        <li>When you're finished, click "Done"</li>
      </ol>
      <p style={{ fontSize: 16 }}>
        Now you can create a bar by clicking the "Create New" button below
      </p>
    </Card>
  );
};
...
const FreeShippingBar = () => {
  return (
    <Card style={{ padding: 20, boxShadow: "none" }}>
      <Typography style={{ fontWeight: 600, fontSize: 18, marginBottom: 32 }}>
    ...
    <Card style={{ padding: 20, boxShadow: "none" }}>
      ...
      <Form.Row>
        ...
        <Form.Group as={Col} md={6}>
          ...
          >
            If native Shopify multi-currencies is configured on your store, this
            Currency Configuration will be disabled. You can enable this if your
            website supports auto-currency detection. FSB auto-converts the goal
            value to the visitors' local currency
          </div>
        </Form.Group>
      </Form.Row>
    </Card>
      ...
      <Form.Row>
        ...
        <Form.Group as={Col} md={6}>
          <Form.Row>
            ...
            <Form.Group as={Col} md={12}>
              <FormControl style={{ marginBottom: 12, marginTop: 16 }}>
                <FormLabel
                  style={{
                    fontSize: 16,
                    color: "#000000",
  ...
  return (
    <Card style={{ padding: 20, boxShadow: "none" }}>
      ...
      <div style={{ fontSize: 12, lineHeight: 2 }}>
        <div>
          <span style={{ color: "#3246D2" }}>Horizontal Zoom:</span> Good for
          displaying a pattern based background image
        </div>
        <div>
          <span style={{ color: "#3246D2" }}>Vertical Scroll:</span> A
          Background image scrolled vertically. Good for showing a product
          image.
        </div>
        <div>
